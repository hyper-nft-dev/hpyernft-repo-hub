import { NFTGenerationRequest, GenerationResult, NFTMetadata, MintingResult, StorageMetadata } from '@types/nft';
...
export class HyperNFTAPIService {
  private baseUrls = {
    generation: 'https://api.hypernft.io/v1/generate',
    minting: 'https://api.hypernft.io/v1/mint',
    storage: 'https://api.hypernft.io/v1/storage',
